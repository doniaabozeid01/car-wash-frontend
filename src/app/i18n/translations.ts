...
export const TRANSLATIONS = {
  en: {
    ...
    cashier: {
      ...
      subscribers: {
        title: 'Subscribers',
        subtitle: 'Customers and their registered cars',
        ...
        saveCar: 'Save Car',
        empty: 'No subscribers yet. They appear after QR scan.'
      },
      freeWashes: {
  ...
  ar: {
    ...
    cashier: {
      ...
      subscribers: {
        title: 'المشتركين',
        subtitle: 'العملاء والعربيات المسجلة',
        monthOnly: 'هذا الشهر فقط',
        customer: 'العميل',
        phone: 'الهاتف',
        plate: 'رقم اللوحة',
        carType: 'نوع السيارة',
        ...
        saveCar: 'حفظ العربية',
        empty: 'لا يوجد مشتركين بعد. يظهرون بعد مسح QR.'
      },
      freeWashes: {
        title: 'حركات الشهر',
